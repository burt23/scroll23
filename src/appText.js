module.exports = {
  ...
  music:
    "My true passion is music: Playing it, making it, and the act of performing and collaborating with other artists. Music my door into the 'zone', and is literally my way of sending good vibrations into the universe. Check out samples of my recordings, some are experimental using BOSS RC-30 and Loop Pedal. And if you want to jam!",
  testimonials:
